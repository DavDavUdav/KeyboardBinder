...
/// </summary>
/// <param name="hInstance"> - ƒескриптор текущего приложени€. </param>
/// <param name="hPrevInstance"> - ƒескриптор предыдущего экземпл€ра приложени€. </param>
/// <param name="lpCmdLine"> - јргументы командной строки без приложени€. </param>
/// <param name="nShowCmd"> - ”правление отображением окна. </param>
/// <returns></returns>
